    ...
    <body >
        <div class = "main">
            <div class="head">            
                <div class="row">
                    <div class="col-sm-8">
                        <h3 class = "head_h1">Update Info</h> 
                    </div>
            ...
            <form id = "srmForm" name= "srmForm" action = "update.php" method = "POST" >
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row['middle_name'];?>" id="mname" name="mname">
                    </div> 
                ...
                <div class= "form-group" id= "enrollment">
                    <label for="course">Enrolled In</label>
                        ...
                        <select id="course" name="course" class = "custom-select" form="srmForm">
                            <option value="" >---</option>
                            <option value="BSc.CSIT" <?php if ($row['enroll']=="BSc.CSIT") echo "selected ='selected' "?> >BSc.CSIT</option>
                            <option value="BIM" <?php if ($row['enroll']=="BIM") echo "selected ='selected' "?> >BIM</option>
                            <option value="BCA" <?php if ($row['enroll']=="BCA") echo "selected ='selected' "?> >BCA</option>
                            <option value="BIT" <?php if ($row['enroll']=="BIT") echo "selected ='selected' "?> >BIT</option>
                        </select>
                        </div>
                </div>
                <a class="btn btn-primary" onclick="submitForm()">Update</a>
